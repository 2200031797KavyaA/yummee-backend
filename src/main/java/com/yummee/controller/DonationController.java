...
import com.yummee.service.DonationService;
...
public class DonationController {
    ...
    public Donation makeDonation(@PathVariable Long userId, @RequestBody Donation donation) {
        return donationService.makeDonation(userId, donation);
    }
